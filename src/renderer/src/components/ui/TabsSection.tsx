        ...
        <TabsList variant="underline" className="px-8">
          {tabs.map((tab) => (
            <TabsTrigger
              ...
              value={tab.value}
              variant="underline"
              className="after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:scale-x-0 after:bg-primary after:transition-transform data-[state=active]:after:scale-x-100"
            >
